...
✅ Conector nativo para Postgres (primeira fonte oficial do AutoSAGE)
✅ Ingestão direta da tabela → sem upload, sem gambiarra
✅ Pipeline automático de validação do dataset
✅ Auto-EDA inteligente com insights de qualidade
✅ Seleção dinâmica do melhor algoritmo (AutoML prático)
✅ Treinamento automatizado com métricas completas
✅ API de inferência pronta para produção
✅ Monitoramento contínuo do modelo (drift, performance e logs)
✅ Explainability integrada (SHAP e feature importance)
✅ Recomendações acionáveis para negócio no output
---
